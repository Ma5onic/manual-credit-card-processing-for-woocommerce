 ...
 * Plugin URI: http://woodev.us/product/woocommerce-manual-credit-card-processing/
 ...
 * Author: Morrison Consulting, LLC
 * Author URI: http://www.woodev.us/
 * Version: 1.4
 *
...
if( ! class_exists( 'MoCoManualPayments' )) {
    ...
    final class MoCoManualPayments {
        ...
        public function plugin_add_pro_link($links ) {
            $settings_link = '<strong><a href="http://woodev.us/product/woocommerce-manual-credit-card-processing/" target="_blank" title="Go pro to unlock new features!">' . __( 'Go Pro!' ) . '</a></strong>';
            ...
            switch ($pagenow) {
                case 'admin-ajax.php':
                    if($_POST && defined( 'DOING_AJAX' ) && !empty($_POST['action'])){
                        $moco_wcc_mcc_ajax_action = array('mc_wc_cc_manual','mc_wc_calculate_shipping','mc_wc_set_shipping','mc_wc_cc_manual_orders','mc_wc_cc_manual_reorder','woocommerce_save_order_items','woocommerce_calc_line_taxes');
